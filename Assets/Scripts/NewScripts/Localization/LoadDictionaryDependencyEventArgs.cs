...
namespace PJW.Localization
{
    ...
    /// 加载字典依赖事件
    /// </summary>
    public class LoadDictionaryDependencyEventArgs : FrameworkEventArgs
    {
        /// <summary>
        /// 加载依赖事件
        /// </summary>
        ...
        public LoadDictionaryDependencyEventArgs(string dictionaryName,string dependencyAssetName,int totalCount,int loadedCount,object userData)
        {
