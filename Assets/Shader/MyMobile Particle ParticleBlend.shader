...
Shader "MyMobile/Particles/ParticleBlend" {
Properties {
	...
	SubShader {
		Pass {
			...
			half4 frag (v2f i) : COLOR
			{
				...
				half alpha = mainTex.a * maskTex.a;
				half4 outColor = fixed4(mainTex.rgb,alpha);
				
				outColor = 2.0f * i.color * _Alpha * outColor * _Color;
